...
public class FileSlide extends Slide {
    ...
    public FileSlide(Context context, Uri uri, long dataSize) throws IOException, MediaTooLargeException {
        super(context, constructAttachmentFromUri(context, uri, ContentType.APP_DRM_CONTENT, dataSize));
