...
import static org.smssecure.smssecure.EspressoUtil.addContact;
import static org.smssecure.smssecure.EspressoUtil.waitOn;
import static org.smssecure.smssecure.ViewMatchers.withRecyclerItem;
import static org.smssecure.smssecure.ViewMatchers.withRecyclerItemCount;

@LargeTest
public class ConversationListActivityTest extends SMSSecureEspressoTestCase<ConversationListActivity> {
  ...
  private void checkOptionsMenuItemsDisplayed() throws Exception {
    ...
    if (!SMSSecurePreferences.isPasswordDisabled(getContext())) {
