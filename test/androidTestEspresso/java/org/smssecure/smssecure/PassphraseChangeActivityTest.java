...
import org.smssecure.smssecure.preferences.AppProtectionPreferenceFragmentActions;
...
@LargeTest
public class PassphraseChangeActivityTest extends SMSSecureEspressoTestCase<ConversationListActivity> {
  ...
  public void testEnablePassphrase() throws Exception {
    ...
    EspressoUtil.waitOn(ApplicationPreferencesActivity.class);
    assertTrue(!SMSSecurePreferences.isPasswordDisabled(getContext()));
  }
