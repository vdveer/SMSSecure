...
import org.smssecure.smssecure.PassphraseChangeActivityActions;
...
@LargeTest
public class AppProtectionPreferenceFragmentTest extends SMSSecureEspressoTestCase<ConversationListActivity> {
  ...
  private void checkViewsMatchPreferences() throws Exception {
    ...
    if (SMSSecurePreferences.isPassphraseTimeoutEnabled(getContext())) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
      if (SMSSecurePreferences.isScreenSecurityEnabled(getContext())) {
